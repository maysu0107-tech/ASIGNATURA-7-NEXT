...
Modelado Predictivo con Machine Learning Desarrollo de un modelo predictivo con base en wms_dataset_clean.xlsx
...
Needs Repair
Objetivo
-Construir un sistema de clasificación capaz de predecir el status operativo de los activos del inventario (In Use, In Storage, Needs Repair) a partir de sus atributos descriptivos, organizativos y logísticos, incorporando además un modelo ensemble y una segmentación no supervisada para apoyar decisiones de gestión de almacén.
